  ...
  return (
    <>
      <div
        ...
        className="fixed top-0 left-0 right-0 h-4 z-[90]"
      />
      <div className="fixed top-2 right-3 z-[100] flex items-center gap-1">
        <button
          ...
          className="w-8 h-8 rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none"
        >
        ...
        <button
          ...
          className="w-8 h-8 rounded-lg flex items-center justify-center text-white/60 hover:text-white hover:bg-red-500/80 focus-visible:ring-2 focus-visible:ring-white/50 focus-visible:outline-none"
        >
          <svg aria-hidden="true" width="10" height="10" viewBox="0 0 10 10" fill="none">
